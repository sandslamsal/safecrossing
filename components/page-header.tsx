...
export function PageHeader({ eyebrow, title, description, imageSrc, imageAlt }: PageHeaderProps) {
  return (
    <section className="relative overflow-hidden px-6 pb-12 pt-14 sm:pt-20 lg:px-8">
      ...
      <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
        <div className="max-w-xl">
          ...
          <h1 className="font-heading text-balance text-4xl leading-tight tracking-[-0.05em] text-ink sm:text-[3.4rem]">{title}</h1>
          <p className="mt-5 text-base leading-7 text-muted sm:text-[1.05rem]">{description}</p>
        </div>
